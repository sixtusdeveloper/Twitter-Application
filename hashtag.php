		...
		<div class="nav-left">
			<ul>
				...
				<?php if ($getFromU->loggedIn() === true) { ?>
					<li><a href="<?php echo BASE_URL; ?>i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Notifications<span id="notificaiton"><?php if (
    $notify->totalN > 0
) {
    echo '<span class="span-i">' . $notify->totalN . '</span>';
} ?></span></a></li>
					<li id="messagePopup"><i class="fa fa-envelope" aria-hidden="true"></i>Messages<span id="messages"><?php if (
         $notify->totalM > 0
     ) {
		...
		<div class="nav-right">
			...
			<?php if ($getFromU->loggedIn() === true) { ?>
				<li class="hover"><label class="drop-label" for="drop-wrap1"><img src="<?php echo BASE_URL .
        $user->profileImage; ?>"/></label>
				<input type="checkbox" id="drop-wrap1">
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							<li><a href="<?php echo BASE_URL .
           $user->username; ?>"><?php echo $user->username; ?></a></li>
				...
				<?php } else {echo '<li><a href="' .
           BASE_URL .
           '/index.php">Have an account? Log in!</a></li>';} ?>
			</ul>
		</div><!-- nav right ends-->
	</div><!-- nav ends -->
...
<div class="hash-menu">
	<div class="hash-menu-inner">
       ...
       'hashtag/' .
       $hashtag .
       '?f=users'; ?>">Accounts</a></li>
			<li><a href="<?php echo BASE_URL .
       'hashtag/' .
       $hashtag .
       '?f=photos'; ?>">Photos</a></li>
  		</ul>
	</div>
</div>
<!--hash-menu-->
              ...
              ($getFromU->loggedIn()
                  ? '
                      ...
                      ((isset($retweet['retweetID'])
                              ? ($tweet->tweetID === $retweet['retweetID'] or
                                  $user_id === $retweet['retweetBy'])
                              : '')
                          ? '<button class="retweeted" data-tweet="' .
                              $tweet->tweetID .
                              '" data-user="' .
                              $tweet->tweetBy .
                              '"><i class="fa fa-retweet" aria-hidden="true"></i><span class="retweetsCount">' .
                              ($tweet->likesCount > 0
                                  ? $tweet->likesCount
                                  : '') .
                              '</span></button>'
                      ...
                      ((isset($likes['likeOn'])
                          ...
                          ? '<button class="unlike-btn" data-tweet="' .
                              ...
                              '" data-user="' .
                              $tweet->tweetBy .
                              '"><i class="fa fa-heart" aria-hidden="true"></i><span class="likesCounter">' .
                              ($tweet->likesCount > 0
                                  ? $tweet->likesCount
                                  : '') .
                              '</span></button>'
                          : '<button class="like-btn" data-tweet="' .
                              ...
                              '" data-user="' .
                              $tweet->tweetBy .
                              '"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="likesCounter">' .
                              ($tweet->likesCount > 0
                                  ? $tweet->likesCount
                                  : '') .
                              '</span></button>') .
...
<?php foreach ($accounts as $users): ?>
 <div class="follow-unfollow-box">
	<div class="follow-unfollow-inner">
        ...
        $users->username; ?>"><?php echo $users->screenName; ?></a>
			</div>
			<div class="follow-person-tname">
				<a href="<?php echo BASE_URL .
        $users->username; ?>">@<?php echo $users->username; ?></a>
			</div>
 ...
 <?php else: ?>
	 ...
	 <div class="in-center">
        ...
        echo '<div class="all-tweet">
            ...
            '
					 		 ' .
            ((isset($retweet['retweetMsg'])
                    ? (!empty($retweet['retweetMsg']) &&
                ...
                ? '<div class="t-show-head">
                    ...
                    ' </span>
									<span>' .
                    $getFromT->timeAgo(isset($retweet['postedOn'])) .
                    '</span>
								</div>
								<div class="t-h-c-dis">
									' .
                    ...
                    '</span>
											<span>' .
                    $getFromT->timeAgo($tweet->postedOn) .
                    '</span>
										</div>
