$(function () {
  $(document).on('click', '.addTweetBtn', function () {
    ...
    $.post('http://localhost/xampp/PHP-NEW-PROJECT/Twitter-Clone-App/Assets/core/ajax/tweetForm.php', function (data) {
  ...
  $(document).on('submit', '#popupForm', function (e) {
    ...
    $.ajax({
      url: 'http://localhost/xampp/PHP-NEW-PROJECT/Twitter-Clone-App/Assets/core/ajax/addTweet.php',
      type: 'POST',
      data: formData,
