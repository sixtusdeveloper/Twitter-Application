					...
					<div class="back-inner">
						...
						<!--Direct Messages-->
							<div class="people-message" data-user="<?= $message->user_id ?>">
								<div class="people-inner">
									<div class="people-img">
										<img src="<?= ROOT_URL . $message->profileImage ?>"/>
									</div>
									<div class="name-right2">
										<span><a href="#"><?= $message->screenName ?></a></span><span>@<?php echo $message->username; ?></span>
									</div>
									<div class="msg-box">
										<?= $message->message ?>
									</div>
									...
									<span>
										<?= $getFromU->timeAgo($message->messageOn) ?>	
									</span>
								</div>
							</div>
							<!--Direct Messages-->
				...
				<div class="message-header2">
					...
					<div class="message-h-cen">
						<div class="message-head-img">
						  <img src="<?= ROOT_URL . $user->profileImage ?>"/><h4>Messages</h4>
						</div>
					</div>
					<div class="message-h-right">
