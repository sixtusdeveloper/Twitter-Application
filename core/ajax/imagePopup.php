...
<div class="img-popup-wrap">
	...
	<div class="img-popup-footer">
		<div class="img-popup-tweet-wrap">
          ...
          $tweet->username; ?>"><?php echo $tweet->screenName; ?></a><span>@<?php echo $tweet->username .
    ' - ' .
    $getFromU->timeAgo($tweet->postedOn); ?></span>
					</div>
        ...
        ($getFromU->loggedIn()
            ? '
								...
								<li>' .
                (($tweet->tweetID === isset($retweet['retweetID']) or
                $user_id === isset($retweet['retweetBy']))
                ...
                '</li>
								<li>' .
                (isset($likes['likeOn']) == $tweet->tweetID
