...
<head>
    <title>People followed by <?php echo $profileData->screenName .
        ' (@' .
                        ...
                        <div class='profile-body'>
                            ...
                            <div class="profile-text">
                                <div class="profile-name">
                                    ...
                                    <h6 class="mt-0" style="color:rgb(91, 112, 131);"><?php echo '@' .
                                        $user->username; ?></h6>
                                </div>
                                <div class="profile-bio">
                                    <h5><?php echo $getFromT->getTweetLinks(
                                        $profileData->bio
                                    ); ?></h5>
                                </div>
                                <div class="profile-link d-flex mt-3">
                                    <?php if (
                                        !empty($profileData->website)
                                    ) { ?>
                                ...
                                <div class="profile-follow mt-2 d-flex">
                                    <h6 class="mr-3 ml-1" style="font-weight: 700;"><?php echo $profileData->following; ?>
                                        <a href="<?php echo BASE_URL .
                                            ...
                                            <a href="<?php echo BASE_URL .
                                                $profileData->username; ?>/following" style="color:rgb(91, 112, 131);">Following</a>
                                        </a></h6>
                                    <h6 class="mr-3" style="font-weight: 700;"><?php echo $profileData->followers; ?>
                                        <a href="<?php echo BASE_URL .
                                            $profileData->username; ?>/followers" style="color:rgb(91, 112, 131);">
                                            Followers
                                        </a></h6>
                                    <h6 style="font-weight: 700;">
                                        <?php echo $getFromT->countTweets(
                                            $profileId
                                        ); ?>
